                ...
                <div class="col-12 col-lg-8 col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="proc_pendencia.php">
                                <div class="form-group">
                                    <input type="text" name="id" class="form-control" value="<?php if (isset($row_cont['id'])) {
                                                                                                    echo $row_cont['id'];
                                                                                                } ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="acao_pendencia">Pendência:</label>
                                    <input type="text" name="acao_pendencia" class="form-control" id="acao_pendencia"><br><br>
                                </div>                                                                                            

                                <div class="form-group">
                                    <input type="submit" value="Enviar" name="SendCadContPend" class="btn btn-light">
                                </div>
                            </form>
                        </div>
                    </div>
