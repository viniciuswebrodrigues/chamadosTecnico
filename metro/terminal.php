  ...
  <div id="wrapper">
    ...
    <!--Start sidebar-wrapper-->
      ...
      <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
          <a href="emaberto.php">
            <i class="zmdi zmdi-alert-polygon"></i> <span>Chamados em aberto -Terminal</span>
          </a>
        </li>

        <li>
          <a href="pendencia.php">
            <i class="zmdi zmdi-format-list-bulleted"></i> <span>Pendências -Terminal</span>
          </a>
        </li>
      </ul>
