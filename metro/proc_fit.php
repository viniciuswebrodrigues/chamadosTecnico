...
if ($SendCadCont) {
  ...
  $nome = $_SESSION['nome'];
  $result = "INSERT INTO ficha_intervencao (id_sol, tecnico, ide, terminal, modelo, opcao, data, hora_inicio, hora_termino, falha_alegada, alegada_outro, falha_constatada, constatada_outro, acao_corretiva, corretiva_outro, conjunta, atendimento, pendencia) 
  VALUES(:id, :nome, :ide, :terminal, :modelo, :opcao, :data, :hora_inicio, :hora_termino, :falha_alegada, :alegada_outro, :falha_constatada, :constatada_outro, :acao_corretiva, :corretiva_outro, :conjunta, :atendimento, :pendencia)";
