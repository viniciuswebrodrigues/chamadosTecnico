...
$sql = "SELECT SUBSTRING_INDEX(SUBSTRING_INDEX(acaminho, ' ', 1), ' ', -1)  AS acaminho, id, ide, nivel, SUBSTRING(terminal, 6) as terminal, SUBSTRING(modelo, 16) as modelo, ultima_venda, SUBSTRING(sonda, 6) as sonda, SUBSTRING_INDEX(SUBSTRING_INDEX(criado, ' ', -1), ' ', 1) as criado, atendimento 
                FROM metroatm 
