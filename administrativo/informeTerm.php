...
<head>
    ...
    <title>Informe de solicitações</title>
    <!-- loader-->
        ...
        <div class="container-fluid">
            <div class="row mt-3">
                <div class="col-12 col-lg-8 col-xl-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Informe de solicitações</div>
                            <form method="POST" action="prioridadeTerm.php">
                                ...
                                <label for="nivel">Nível da solicitação</label>
                                <div class="form-group">
									<select type="text" name="prioridade" class="form-control" id="prioridade">
										<option></option>
                                ...
                                <label for="nivel">Periférico</label>
                                <div class="form-group">
									<select type="text" name="periferico" class="form-control" id="periferico">
										<option></option>
                                        <option>Aceitador</option>
                                        <option>Pinpad</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <input type="submit" value="Informar" name="Send" class="btn btn-light">
                                </div>
                            </form>
