	...
	if(!empty($_FILES['arquivo']['tmp_name'])){
		...
		foreach($linhas as $linha){
			if($primeira_linha == false){
				...
				$sql = "INSERT INTO metroatm (ide, terminal, modelo, ultima_venda, sonda, criado) VALUES (:ide, :terminal, :modelo, :ultima_venda, :sonda, NOW())";
				...
				if ($sql->execute()){
					$_SESSION['msg'] = "<button type'button' class='close' data-dismiss='alert'>×</button><strong>Solicitação enviada com sucesso!</strong>";
