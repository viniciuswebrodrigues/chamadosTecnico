                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="proc_fit.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" class="form-group" name="falha_alegada" value="ronda"> <label> Ronda</label><br>
                                    ...
                                    <input type="radio" class="form-group" name="falha_alegada" value="limpeza preventiva"> <label> Limpeza preventiva</label><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" class="form-group" name="falha_constatada" value="ronda"> <label> Ronda</label><br>
                                    ...
                                    <input type="radio" class="form-group" name="falha_constatada" value="limpeza preventiva"> <label> Limpeza preventiva</label><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" class="form-group" name="acao_corretiva" value="ronda"> <label> Ronda</label><br>
                                    ...
                                    <input type="radio" class="form-group" name="acao_corretiva" value="limpeza preventiva"> <label> Limpeza preventiva</label><br>
